	...
	<div class="modal-dialog">
     ...
     <div class="transactions-table-th d-none d-md-block">
        <div class="col-12">
			...
			<form action="proses_update_petugas.php" method="POST" class="user">
      <?php 
				include '../koneksi.php';
        $id = $_GET['id'];
				...
				<div class="modal-body">				
					<div class="form-group">
						...
						<input type="hidden" name="id_petugas" value="<?php echo $d['id_petugas']; ?>" class="form-control">
						<input type="text" name="nama_petugas" value="<?php echo $d['nama_petugas']; ?>" class="form-control">
					</div>
					<div class="form-group">
